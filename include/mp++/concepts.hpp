...
MPP_CONCEPT_DECL CppIntegralInteroperable = is_cpp_integral_interoperable<T>::value;
#else
...
template <typename T>
#if defined(MPPP_HAVE_CONCEPTS)
MPP_CONCEPT_DECL CppUnsignedIntegralInteroperable = is_cpp_unsigned_integral_interoperable<T>::value;
#else
...
template <typename T>
#if defined(MPPP_HAVE_CONCEPTS)
MPP_CONCEPT_DECL CppSignedIntegralInteroperable = is_cpp_signed_integral_interoperable<T>::value;
#else
...
template <typename T>
#if defined(MPPP_HAVE_CONCEPTS)
MPP_CONCEPT_DECL CppFloatingPointInteroperable = is_cpp_floating_point_interoperable<T>::value;
#else
...
template <typename T>
#if defined(MPPP_HAVE_CONCEPTS)
MPP_CONCEPT_DECL CppInteroperable = is_cpp_interoperable<T>::value;
#else
...
template <typename T>
#if defined(MPPP_HAVE_CONCEPTS)
MPP_CONCEPT_DECL StringType = is_string_type<T>::value;
#else
