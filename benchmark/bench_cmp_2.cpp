...
NONIUS_BENCHMARK("mppp 1-1-limb cmp", [](nonius::chronometer meter) { cmp_vec_mppp<integer>(meter, rng, 1, 1); });
NONIUS_BENCHMARK("mppp 2-2-limb cmp", [](nonius::chronometer meter) { cmp_vec_mppp<integer>(meter, rng, 2, 2); });
NONIUS_BENCHMARK("mppp 3-3-limb cmp", [](nonius::chronometer meter) { cmp_vec_mppp<integer>(meter, rng, 3, 3); });

NONIUS_BENCHMARK("gmp 1-1-limb cmp", [](nonius::chronometer meter) { cmp_vec_gmp(meter, rng, 1, 1); });
