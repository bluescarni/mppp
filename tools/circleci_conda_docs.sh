...
mamba create -y -p $deps_dir c-compiler cxx-compiler ninja cmake gmp mpfr libflint mpc fmt libboost-devel 'sphinx=6.*' 'sphinx-book-theme=1.*' myst-nb xeus-cling
