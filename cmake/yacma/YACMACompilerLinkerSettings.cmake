...
if(${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang")
    set(YACMA_COMPILER_IS_CLANGXX 1 CACHE INTERNAL "")
endif()

if(${CMAKE_CXX_COMPILER_ID} STREQUAL "Intel")
    set(YACMA_COMPILER_IS_INTELXX 1 CACHE INTERNAL "")
endif()

if(MSVC)
    set(YACMA_COMPILER_IS_MSVC 1 CACHE INTERNAL "")
endif()

if(CMAKE_COMPILER_IS_GNUCXX)
    set(YACMA_COMPILER_IS_GNUCXX 1 CACHE INTERNAL "")
endif()
